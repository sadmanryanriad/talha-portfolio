//add some social media links, also fiverr and others
const Footer = () => {
    return (
<footer className="footer max-w-7xl mx-auto rounded-lg items-center p-4 bg-gray-200 dark:bg-gray-700 dark:text-white mt-28">
